...
public class ProfessorController {
    ...
    @PostMapping
    private ResponseEntity<Object> cadastrar(@Valid @RequestBody final ProfessorDTO professorDTO){
        try {
    ...
    private ResponseEntity<Object> editar(@RequestParam("id") final Long id, @Valid @RequestBody final ProfessorDTO professorNovo){
        try {
